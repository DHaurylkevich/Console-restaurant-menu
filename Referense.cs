...
namespace RestaurantMenu
{
    ...
    internal class Program
    {
        ...
        private static void Main (string[] args)
        {
            ...
            {
                new Vegetables { name = "Mashrooms", number = 1, price = 15, alergie = 0 },
                new Vegetables { name = "Bell pepper", number = 2, price = 17, alergie = 0 },
                new Vegetables { name = "Broccoli", number = 3, price = 13, alergie = 0 },
                new Vegetables { name = "Green Beans", number = 4, price = 10, alergie = 0 },
                new Vegetables { name = "Corn", number = 5, price = 18, alergie = 0 }
            }; // List of Vegetables
